                  ...
                  <ul className="contact-info">
                    <li>
                      ...
                      <div className="content">
                        <p>Address</p>
                        <p className="white">[Place Holder]</p>
                      </div>
                    </li>
                    <li>
                      <div className="icon">
                      ...
                      <div className="content">
                        <p>Phone</p>
                        <p className="white">+1 (302) 494 3133</p>
                      </div>
                    </li>
                    <li>
                      <div className="icon">
                      ...
                      <div className="content">
                        <p>Email</p>
                        <p className="color-hover">greer@heartinthegame.org</p>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div className="row">
                <div className="col-md-6">
                  <div
                    ...
                    data-aos-duration={800}
                  >
                    <h3 className="title">Support Heart in the Game</h3>
                    <p className="sub">
                      Protect young hearts, save young lives
                    </p>
                    <div className="wrap-btn">
                      <a href="/assets/images/qrcode.png" className="tf-button style3 text-white" target="_blank" rel="noopener noreferrer">
                        Donate Today
                      </a>
                    </div>
                  </div>
