                    ...
                    <section className="tf-section project">
                        <div className="container">
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="flat-tabs" data-aos="fade-up" data-aos-duration={1000}>
                                        ...
                                        <div className="content-tab mt40">
                                            <div className="content-inner project-box-style3_wrapper" style={{ display: `${activeIndex == 1 ? "block" : "none"}` }}>
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        <div className="image">
                                                            <img className="mask" src="/assets/images/common/project_29.png" alt="" />
                                                            <div className="shape">
                                                                <img src="/assets/images/common/shape_2.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <h5 className="heading"><Link href="/our-story">Zombie plant 2</Link></h5>
                                                    </div>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        <div className="image">
                                                            <img className="mask" src="/assets/images/common/project_30.png" alt="" />
                                                            <div className="shape">
                                                                <img src="/assets/images/common/shape_2.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <h5 className="heading"><Link href="/our-story">Codyfight IGO</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        <div className="image">
                                                            <img className="mask" src="/assets/images/common/project_31.png" alt="" />
                                                            <div className="shape">
                                                                <img src="/assets/images/common/shape_2.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <h5 className="heading"><Link href="/our-story">Shadow Fight 2</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        <div className="image">
                                                            <img className="mask" src="/assets/images/common/project_32.png" alt="" />
                                                            <div className="shape">
                                                                <img src="/assets/images/common/shape_2.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <h5 className="heading"><Link href="/our-story">Shadow Fight Arena</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        <div className="image">
                                                            <img className="mask" src="/assets/images/common/project_33.png" alt="" />
                                                            <div className="shape">
                                                                <img src="/assets/images/common/shape_2.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <h5 className="heading"><Link href="/our-story">Plants vs. Zombies™</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        <div className="image">
                                                            <img className="mask" src="/assets/images/common/project_11.png" alt="" />
                                                            <div className="shape">
                                                                <img src="/assets/images/common/shape_2.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <h5 className="heading"><Link href="/our-story">Modern Combat 5: mobile FPS</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        <div className="image">
                                                            <img className="mask" src="/assets/images/common/project_9.png" alt="" />
                                                            <div className="shape">
                                                                <img src="/assets/images/common/shape_2.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <h5 className="heading"><Link href="/our-story">Street Fighter IV CE</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        ...
                                                        <h5 className="heading"><Link href="/our-story">Ninja Ryuko: Shadow Ninja Game</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        <div className="image">
                                                            <img className="mask" src="/assets/images/common/project_34.png" alt="" />
                                                            <div className="shape">
                                                                <img src="/assets/images/common/shape_2.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <h5 className="heading"><Link href="/our-story">Quadropus Rampage</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        <div className="image">
                                                            <img className="mask" src="/assets/images/common/project_35.png" alt="" />
                                                            <div className="shape">
                                                                <img src="/assets/images/common/shape_2.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <h5 className="heading"><Link href="/our-story">Sniper Honor: 3D Shooting Game</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                            ...
                                            <div className="content-inner project-box-style3_wrapper" style={{ display: `${activeIndex == 2 ? "block" : "none"}` }}>
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        <div className="image">
                                                            <img className="mask" src="/assets/images/common/project_29.png" alt="" />
                                            ...
                                            <div className="content-inner project-box-style3_wrapper" style={{ display: `${activeIndex == 3 ? "block" : "none"}` }}>
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        <div className="image">
                                                            <img className="mask" src="/assets/images/common/project_33.png" alt="" />
                                ...
                                <div className="col-md-12">
                                    <ul className="panigation mt40" data-aos="fade-up" data-aos-duration={800}>
                                        <li>
                                            <Link href="#">
